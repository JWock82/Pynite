...
class Test_2D_Frame(unittest.TestCase):
    ...
    def test_XY_gravity_load(self):
        ...
        correct_values = [
            ("N1", {"RxnFX": 11.6877, "RxnFY": 30, "RxnMZ": -1810.0745}),
            ("N6", {"RxnFX": -11.6877, "RxnFY": 30, "RxnMZ": 1810.0745}),
        ]
    ...
    def test_XY_member_ptload(self):
        ...
        # Define materials
        frame.add_material(
            "Steel", 29000 * 12**2, 1111200 * 12**2, 0.5, 490 / 1000 / 12**3
        )
    ...
    def test_YZ_gravity_load(self):
        ...
        correct_reactions = [
            ("N1", {"RxnFZ": 11.6877, "RxnFY": 30, "RxnMX": 1810.0745}),
            ("N6", {"RxnFZ": -11.6877, "RxnFY": 30, "RxnMX": -1810.0745}),
        ]
        ...
        correct_displacements = [
            ("N3", {"DY": -6.666757, "RX": 0.032}),
            ("N4", {"DY": -6.666757, "RX": -0.032}),
        ]
    ...
    def test_XZ_ptload(self):
        ...
        correct_reactions = [("N1", -2.5), ("N2", -2.5)]
