...
def test_cantilever_frequency():
    ...
    model.analyze_modal(
        num_modes=3,
        mass_combo_name="Consistent Mass Combo",
        mass_direction="Y",
        gravity=9.81,
        log=False,
    )
    ...
    model.analyze_modal(
        num_modes=3,
        mass_combo_name="Lumped Mass Combo",
        mass_direction="Y",
        gravity=9.81,
        log=False,
    )
    ...
    f_analytical = [
        analytical_cantilever_frequency(i, L, E, I, rho, A, 9.81) for i in range(1, 4)
    ]
...
def test_mass_increase():
    ...
    # Run the analysis
    model.analyze_modal(
        num_modes=1, mass_combo_name="MassCombo1", mass_direction="Y", log=False
    )
    freq1 = model.frequencies
    model.analyze_modal(
        num_modes=1, mass_combo_name="MassCombo2", mass_direction="Y", log=False
    )
