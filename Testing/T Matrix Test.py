...
truss.def_releases(
    "ab", False, False, False, False, True, True, False, False, False, False, True, True
)
truss.def_releases(
    "ac", False, False, False, False, True, True, False, False, False, False, True, True
)
truss.def_releases(
    "ad", False, False, False, False, True, True, False, False, False, False, True, True
)
truss.def_releases(
    "ae", False, False, False, False, True, True, False, False, False, False, True, True
)
...
# Render the model
Visualization.RenderModel(
    truss, text_height=0.2, deformed_shape=True, deformed_scale=1000, render_loads=True
)
