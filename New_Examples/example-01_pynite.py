...
print(
    "Maximum Moment:",
    SimpleBeam.Members["M1"].max_moment("Mz", "1.2D+1.6L") / 12,
    "kip-ft",
)
print(
    "Minimum Moment:",
    SimpleBeam.Members["M1"].min_moment("Mz", "1.2D+1.6L") / 12,
    "kip-ft",
)
...
print(
    "Maximum Deflection:",
    SimpleBeam.Members["M1"].max_deflection("dy", "1.2D+1.6L"),
    "in",
)
print(
    "Minimum Deflection:",
    SimpleBeam.Members["M1"].min_deflection("dy", "1.2D+1.6L"),
    "in",
)
