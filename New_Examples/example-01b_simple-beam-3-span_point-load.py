...
def main():
    ...
    fname_vtk = "example-01b-vtk.png"
    fname_fig = "example-01b.png"
    fname_rpt = "example-01b_rpt.pdf"
    ...
    for idx, span in enumerate(spans):
        print(f"Element: {'m' + str(idx)}, 'Fy', -5, {span * 12/2}")
        sbeam.add_member_pt_load("m" + str(idx), "Fy", pt_load, span * 12 / 2)
