...
#%% 
    ...
    def __init__(self):
        ...
        self.__Nodes = []     # A list of nodes in the structure
        self.__Members = []   # A list of members in the structure
...
#%%
    def AddNode(self, Name, X, Y, Z):
        ...
        # Create the new node
        newNode = Node3D(Name, len(self.__Nodes), X, Y, Z)
...
#%%
    def AddMember(self, Name, iNode, jNode, E, G, Iy, Iz, J, A):
        ...
        newMember = Member3D(Name, len(self.__Members), self.GetNode(iNode), self.GetNode(jNode), E, G, Iy, Iz, J, A)
...
#%%    
    def K(self):
        ...
        stiffMatrix = zeros((len(self.__Nodes)*6, len(self.__Nodes)*6))
...
#%%
    ...
    def P(self):
        ...
        pVector = zeros((len(self.__Nodes)*6, 1))
