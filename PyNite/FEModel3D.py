...
"""
# %%
from numpy import zeros, delete, insert, invert
...
#%%    
    ...
    def FER(self):
        ...
        for member in self.Members:
            ...
            # Fill in the i-node diagonal terms
            for a in range(0,6):
                m = member.iNode.ID*6+a
