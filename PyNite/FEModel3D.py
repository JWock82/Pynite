...
class FEModel3D():
    """
    A class for creating 3D finite element models.
    """
...
#%% 
    def __init__(self):
        ...
        self.__Displacements = []   # A list of the structure's nodal displacements
        self.__Solved = False       # Indicates whether the model is solved or not
...
#%%
    def DefineReleases(self, Member, Dxi = False, Dyi = False, Dzi = False, Rxi = False, Ryi = False, Rzi = False, Dxj = False, Dyj = False, Dzj = False, Rxj = False, Ryj = False, Rzj = False):
        ...
        # Flag the model as unsolved due to new end release conditions
        self.__Solved = False         
...
#%%      
    def AddMemberPtLoad(self, Member, Direction, P, x):
        ...
        # Flag the model as unsolved due to the new point load
        self.__Solved = False
...
#%%
    def AddMemberDistLoad(self, Member, Direction, w1, w2, x1, x2):
        ...
        # Flag the model as unsolved due to the new distributed load
        self.__Solved = False
...
#%%    
    ...
    def FER(self):
        ...
        ferVector = zeros((len(self.__Nodes)*6, 1))
...
#%%
    ...
    def P(self):
        ...
        for node in self.__Nodes:
            ...
            # Add the nodal load to the global nodal load vector
...
#%%  
    def Analyze(self):
        ...
        self.__Displacements = matmul(inv(K), subtract(P, FER))
        
        # Save the displacements as a local variable for easier reference below
        D = self.__Displacements
        ...
        # Calculate reactions at each node
        for node in self.__Nodes:
        ...
        # Segment all members in the model
        for member in self.__Members:
