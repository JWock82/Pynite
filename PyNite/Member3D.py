...
#%%
    def k(self):
        ...
        # Step through each term (m = row, n = column)
        for m in range(12):
            for n in range(12):
                ...
                if self.Releases[m] == False and self.Releases[n] == False:
                    ...
                    k11.itemset((m11, n11), k.item(m, n))
                    ...
                    k12.itemset((m12, n12), k.item(m, n))
                    ...
                    k21.itemset((m21, n21), k.item(m, n))
                    ...
                    k22.itemset((m22, n22), k.item(m, n))
        ...
        kCondensed = subtract(k11, matmul(matmul(k12, inv(k22)), k21))
        
        # Expand the condensed stiffness matrix
        i=0
        for DOF in self.Releases:
            
            if DOF == True:
                kCondensed = insert(kCondensed, i, 0, axis = 0)
                kCondensed = insert(kCondensed, i, 0, axis = 1)
...
#%%
    def fer(self):
        ...
        # Initialize each partitioned stiffness matrix
        k11 = zeros((12 - NumReleases, 12 - NumReleases))
        k12 = zeros((12 - NumReleases, NumReleases))
        k21 = zeros((NumReleases, 12 - NumReleases))
        k22 = zeros((NumReleases, NumReleases))
...
#%%
    def GetMaxShear(self, Direction):
        """
...
#%%
    def GetMinShear(self, Direction):
        """
...
#%%
    def PlotShearDiagram(self, Direction):
        """
        ...
        for i in range(20):
            ...
            M.append(self.GetShear(Direction, self.L / 19 * i))
...
#%%
    def GetMoment(self, Direction, x):
        """
        ...
        Direction : string
            The direction in which to find the moment. Must be one of the following:
                ...
                "Mz" = moment about the local x-axis
        x : number
...
#%%
    def GetMaxMoment(self, Direction):
        """
        ...
        return Mmax
#%%
    def GetMinMoment(self, Direction):
        """
        ...
        return Mmin
#%%
    def PlotMomentDiagram(self, Direction):
        """
        ...
        for i in range(20):
            ...
            x.append(self.L / 19 * i)
            M.append(self.GetMoment(Direction, self.L / 19 * i))
...
#%%    
    ...
    def SegmentMember(self):
        ...
        fer = self.ferUncondensed() # Member local fixed end reaction vector
