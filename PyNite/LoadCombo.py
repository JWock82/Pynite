class LoadCombo():
    ...
    def __init__(self, name, combo_tag=None, factors={}):
        ...
        self.combo_tag = combo_tag   # Used to categorize the load combination (e.g. strength or serviceability)
