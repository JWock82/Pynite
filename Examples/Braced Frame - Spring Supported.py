...
braced_frame.add_spring(
    "Spring1", "N1", "N1s", 10000, tension_only=True, comp_only=False
)
braced_frame.add_spring(
    "Spring2", "N4", "N4s", 10000, tension_only=False, comp_only=True
)  # The structure would be unstable if
