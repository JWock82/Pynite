...
model.add_shear_wall(
    "Wall 1", mesh_size, length, height, t, "Concrete", ky_mod, "XY", [0, 0, 0]
)
...
model.shear_walls["Wall 1"].add_opening(
    "Opng 1", x_start=5, y_start=6, width=4, height=2, tie=None
)
...
model.shear_walls["Wall 1"].add_flange(
    t, width=3, x=0, y_start=0, y_end=height, material="Concrete", side="+z"
)
...
model.shear_walls["Wall 1"].add_story(
    story_name="Roof", elevation=height, x_start=0, x_end=length
)
