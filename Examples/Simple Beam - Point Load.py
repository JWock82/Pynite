...
simple_beam.def_support(
    "N1", True, True, True, True, False, False
)  # Constrained for torsion at 'N1'
simple_beam.def_support(
    "N2", True, True, True, False, False, False
)  # Not constrained for torsion at 'N2'
...
print(
    "Maximum Moment:",
    simple_beam.members["M1"].max_moment("Mz", "1.2D+1.6L") / 12,
    "kip-ft",
)
print(
    "Minimum Moment:",
    simple_beam.members["M1"].min_moment("Mz", "1.2D+1.6L") / 12,
    "kip-ft",
)
...
print(
    "Maximum Deflection:",
    simple_beam.members["M1"].max_deflection("dy", "1.2D+1.6L"),
    "in",
)
print(
    "Minimum Deflection:",
    simple_beam.members["M1"].min_deflection("dy", "1.2D+1.6L"),
    "in",
)
...
Reporting.create_report(
    simple_beam,
    output_filepath="./Pynite Report.html",
    format="pdf",
    node_table=False,
    plate_table=False,
