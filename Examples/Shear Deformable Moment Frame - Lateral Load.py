...
# Copied from "Moment Frame - Lateral Load.py" but using shear deformable members
...
J = 0.58 # in^4
A = 9.71 # in^2
ksy = 0.2912 # unitless -- shear correction for shear parallel to y (major axis bending)
ksz = 0.2972 # unitless -- shear correction for shear parallel to z (minor axis bending)
MomentFrame.add_section('W10x33', A, Iy, Iz, J, ksy=ksy, ksz=ksz)
...
# Define the columns
MomentFrame.add_member('Col1', 'N1', 'N2', 'Steel', 'W10x33', shear_deformable=True)
MomentFrame.add_member('Col2', 'N4', 'N3', 'Steel', 'W10x33', shear_deformable=True)
...
J = 0.346 # in^4
A = 7.08 # in^2
ksy = 0.2725 # unitless -- shear correction for shear parallel to y (major axis bending)
ksz = 0.3060 # unitless -- shear correction for shear parallel to z (minor axis bending)
MomentFrame.add_section('W8x24', A, Iy, Iz, J, ksy=ksy, ksz=ksz)

# Define the beams
MomentFrame.add_member('Beam', 'N2', 'N3', 'Steel', 'W8x24', shear_deformable=True)
