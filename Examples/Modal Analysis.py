...
nu = 0.3
rho = 0.0000000001 # 0.490/12**3 Density of steel

weight_Y = 190  # kip

# Section properties from AISC database with actual I_minor and J values
WSection = {
    'W14X176': [51.7, 2150., 838., 26.5],   # [A, I_major (Iz), I_minor (Iy), J]
...
# Support all nodes in the Z, RY, and RX directions (this is a planar problem)
