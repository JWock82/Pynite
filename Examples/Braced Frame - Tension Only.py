...
braced_frame.def_support(
    "N1", support_DX=True, support_DY=True, support_DZ=True, support_RY=True
)
braced_frame.def_support(
    "N4", support_DX=True, support_DY=True, support_DZ=True, support_RY=True
)
...
# neglected.
braced_frame.add_member_dist_load(
    "Beam", direction="Fy", w1=-0.024 / 12, w2=-0.024 / 12, x1=0, x2=15 * 12, case="D"
)
braced_frame.add_member_dist_load(
    "Col1", direction="Fx", w1=-0.033 / 12, w2=-0.033 / 12, x1=0, x2=12 * 12, case="D"
)
braced_frame.add_member_dist_load(
    "Col2", direction="Fx", w1=-0.033 / 12, w2=-0.033 / 12, x1=0, x2=12 * 12, case="D"
)
...
print(
    "1.2D+1.0W: N1 reaction FY =",
    "{:.3f}".format(braced_frame.nodes["N1"].RxnFY["1.2D+1.0W"]),
    "kip",
)
print(
    "1.2D+1.0W: N1 reaction FX =",
    "{:.3f}".format(braced_frame.nodes["N1"].RxnFX["1.2D+1.0W"]),
    "kip",
)
print(
    "1.2D+1.0W: N4 reaction FY =",
    "{:.3f}".format(braced_frame.nodes["N4"].RxnFY["1.2D+1.0W"]),
    "kip",
)
print(
    "1.2D+1.0W: N4 reaction FX =",
    "{:.3f}".format(braced_frame.nodes["N4"].RxnFX["1.2D+1.0W"]),
    "kip",
)
