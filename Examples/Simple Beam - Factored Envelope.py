...
_, M2 = simple_beam.members["M1"].moment_array(
    "Mz", n_points=400, combo_name="1.2D+1.6L"
)
_, M3 = simple_beam.members["M1"].moment_array(
    "Mz", n_points=400, combo_name="1.2D+1.6S"
)
