...
* Generates PDF reports of model and results.
...
# What's New?
Version 0.0.14:
Clean looking pdf reports can now be generated by PyNite. See "Simple Beam - Point Load.py" and "Out-of-Plane Wall Panel.py" for examples on how to use this feature. Updates to the wiki will follow. Input validation has also been improved thanks to the help of tamalone1.
