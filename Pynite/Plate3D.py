...
class Plate3D:
    ...
    def Db(self) -> NDArray[float64]:
        ...
        Db = (
            t**3
            / (12 * (1 - nu_xy * nu_yx))
            * array([[Ex, nu_yx * Ex, 0], [nu_xy * Ey, Ey, 0], [0, 0, G]])
        )
    ...
    def B_m(self, r: float, s: float) -> NDArray[float64]:
        ...
        dH = matmul(
            ...
            1
            / 4
            * array([[s - 1, -s + 1, s + 1, -s - 1], [r - 1, -r - 1, r + 1, -r + 1]]),
        )
    ...
    def k_m(self) -> NDArray[float64]:
        ...
        k = t * (
            matmul(B1.T, matmul(Dm, B1)) * det(self.J(-gp, -gp))
                ...
                [
                    [
                        (
                            ...
                            - Ey * nu_xy * b**2 * c**2 / 4
                            - Ey * b**4
                            + 7 * G * nu_xy * nu_yx * b**2 * c**2 / 5
                            - 7 * G * b**2 * c**2 / 5
                        )
                        / (b**3 * c**3 * (nu_xy * nu_yx - 1)),
                        (
                            -Ex * nu_yx * c**2 / 2
                            - Ey * b**2
                            + G * nu_xy * nu_yx * c**2 / 5
                        ...
                        (
                            ...
                            + 5 * Ey * nu_xy * b**2 * c**2
                            - 10 * Ey * b**4
                            - 28 * G * nu_xy * nu_yx * b**2 * c**2
                            + 28 * G * b**2 * c**2
                        )
                        / (20 * b**3 * c**3 * (nu_xy * nu_yx - 1)),
                        (
                            Ex * nu_yx * c**2 / 2
                            - Ey * b**2 / 2
                            - G * nu_xy * nu_yx * c**2 / 5
                        ...
                        / (b * c**2 * (nu_xy * nu_yx - 1)),
                        (5 * Ex * c**2 - G * nu_xy * nu_yx * b**2 + G * b**2)
                        / (5 * b**2 * c * (nu_xy * nu_yx - 1)),
                        (
                            -5 * Ex * nu_yx * b**2 * c**2
                            + 10 * Ex * c**4
                            - 5 * Ey * nu_xy * b**2 * c**2
                        ...
                        / (20 * b**3 * c**3 * (nu_xy * nu_yx - 1)),
                        (-Ey * b**2 / 2 - G * nu_xy * nu_yx * c**2 / 5 + G * c**2 / 5)
                        / (b * c**2 * (nu_xy * nu_yx - 1)),
                        (Ex * c**2 / 2 + G * b**2 * (nu_xy * nu_yx - 1) / 5)
                        / (b**2 * c * (nu_xy * nu_yx - 1)),
                        (
                            5 * Ex * nu_yx * b**2 * c**2
                            - 10 * Ex * c**4
                        ...
                        / (20 * b**3 * c**3 * (nu_xy * nu_yx - 1)),
                        (-5 * Ey * b**2 + G * nu_xy * nu_yx * c**2 - G * c**2)
                        / (5 * b * c**2 * (nu_xy * nu_yx - 1)),
                        (
                            Ex * c**2 / 2
                            - Ey * nu_xy * b**2 / 2
                            + G * b**2 * (nu_xy * nu_yx - 1) / 5
                        )
                        / (b**2 * c * (nu_xy * nu_yx - 1)),
                    ],
                    [
                        ...
                        / (b * c**2 * (nu_xy * nu_yx - 1)),
                        4
                        * (-5 * Ey * b**2 + 2 * G * nu_xy * nu_yx * c**2 - 2 * G * c**2)
                        / (15 * b * c * (nu_xy * nu_yx - 1)),
                        Ey * nu_xy / (nu_xy * nu_yx - 1),
                        (
                            Ey * nu_xy * c**2 / 2
                            - Ey * b**2 / 2
                            - G * nu_xy * nu_yx * c**2 / 5
                        ...
                        / (b * c**2 * (nu_xy * nu_yx - 1)),
                        2
                        * (-5 * Ey * b**2 - 4 * G * nu_xy * nu_yx * c**2 + 4 * G * c**2)
                        / (15 * b * c * (nu_xy * nu_yx - 1)),
                        0,
                        (Ey * b**2 / 2 + G * nu_xy * nu_yx * c**2 / 5 - G * c**2 / 5)
                        / (b * c**2 * (nu_xy * nu_yx - 1)),
                    ...
                    [
                        ...
                        / (b**2 * c * (nu_xy * nu_yx - 1)),
                        Ex * nu_yx / (nu_xy * nu_yx - 1),
                        4
                        * (-5 * Ex * c**2 + 2 * G * nu_xy * nu_yx * b**2 - 2 * G * b**2)
                        / (15 * b * c * (nu_xy * nu_yx - 1)),
                        (-5 * Ex * c**2 + G * nu_xy * nu_yx * b**2 - G * b**2)
                        / (5 * b**2 * c * (nu_xy * nu_yx - 1)),
                        0,
                        ...
                        * (-5 * Ex * c**2 - G * nu_xy * nu_yx * b**2 + G * b**2)
                        ...
                        / (b**2 * c * (nu_xy * nu_yx - 1)),
                        0,
                        (-5 * Ex * c**2 + 2 * G * b**2 * (nu_xy * nu_yx - 1))
                        / (15 * b * c * (nu_xy * nu_yx - 1)),
                        (
                            -Ex * nu_yx * b**2 / 2
                            + Ex * c**2 / 2
                        ...
                        / (b**2 * c * (nu_xy * nu_yx - 1)),
                        0,
                        -(10 * Ex * c**2 + 8 * G * b**2 * (nu_xy * nu_yx - 1))
                        / (15 * b * c * (nu_xy * nu_yx - 1)),
                    ],
                    [
                        (
                    ...
                    [
                        ...
                        (
                            -5 * Ex * c**2
                            - 25 * Ey * nu_xy * b**2
                            + 2 * b**2 * (15 * Ey * nu_xy - G * nu_xy * nu_yx + G)
                        )
                        / (10 * b**2 * c * (nu_xy * nu_yx - 1)),
                        (
                            -Ex * nu_yx * b**2 * c**2 / 4
                            - Ex * c**4
                            - Ey * nu_xy * b**2 * c**2 / 4
                    ...
                    [
                        ...
                        * (-5 * Ex * c**2 + 2 * G * b**2 * (nu_xy * nu_yx - 1))
                        ...
                        / (b**2 * c * (nu_xy * nu_yx - 1)),
                        0,
                        -(10 * Ex * c**2 + 2 * G * b**2 * (nu_xy * nu_yx - 1))
                        / (15 * b * c * (nu_xy * nu_yx - 1)),
                    ],
                    [
                        (
    ...
    def moment(
        self, x: float, y: float, local: bool = True, combo_name: str = "Combo 1"
    ) -> NDArray[float64]:
        """
